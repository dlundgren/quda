<?php
//$role = $this->user->role();
//$inAdmin = $this->urlStartsWithRoute('admin-dashboard');
...
<head>
	...
	<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous" media="all">
...
<div class="page-container">
	<?=(isset($this->user) ? $this->partial('navbar') : '')?>
	<?= isset($this->content) ? $this->raw('content') : $this->content ?>
</div>
